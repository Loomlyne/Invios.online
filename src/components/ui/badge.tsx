...
const badgeVariants = cva(
  "inline-flex items-center rounded-full border px-3 py-1 text-xs font-medium tracking-[0.16em] uppercase",
  {
    variants: {
      variant: {
        default: "border-border-brand bg-surface-subtle text-foreground",
        ...
        info: "border-blue-700/20 bg-blue-50 text-blue-800",
        destructive: "border-red-700/20 bg-red-50 text-red-800",
